...
const Header = () => {
  ...
  return (
    <header
      className='container allcenter justify-between font-mono min-w-full top-0 relative'
      onClick={() => {
    ...
    >
      ...
      <div className='-top-7 right-0 md:hidden p-10 absolute '>
        ...
        <motion.div
          className={`${
            menu ? "block" : "hidden"
          } right-0 absolute top-0 z-50  w-screen h-screen bg-blue min-h-72 flex justify-center p-28`}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
