...
const About = () => {
  return (
    <div
      className='w-[80%] flex flex-col lg:flex-row gap-1 bg-white min-h-36 absolute  md:-bottom-12 lg:-bottom-24 z-20 left-[10%] right-[10%] allcenter p-5 justify-between shadow-xl lg:gap-5'
      id='cv'
    >
